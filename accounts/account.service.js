...
function generateJwtToken(account){
  // create a jwt token containing the acocunt id that expires in 15 minutes
...
async function sendPasswordResetEmail(account, origin){
  ...
  if (origin){
    ...
    message = `<p>Please click the below link to reset your password, the link will be valird for 1 hour.</p>
